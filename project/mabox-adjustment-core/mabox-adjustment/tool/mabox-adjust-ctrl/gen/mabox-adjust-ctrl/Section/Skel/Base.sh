...
is_debug () {
	if [ "$DEBUG_MABOX_ADJUST_CTRL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME='mabox-adjust-ctrl'
	fi
	...
	THE_SELF_UPDATE_URL='https://raw.githubusercontent.com/samwhelp/mabox-adjustment/main/project/mabox-adjustment-core/mabox-adjustment/tool/mabox-adjust-ctrl/mabox-adjust-ctrl'
	...
	## mabox-adjustment
	THE_MABOX_ADJUSTMENT_PLAN_DIR_NAME="mabox-adjustment"
	THE_MABOX_ADJUSTMENT_PLAN_SYSTEM_DIR_PATH="/usr/share/${THE_MABOX_ADJUSTMENT_PLAN_DIR_NAME}"
	THE_MABOX_ADJUSTMENT_PLAN_PERSON_DIR_PATH="${HOME}/.config/${THE_MABOX_ADJUSTMENT_PLAN_DIR_NAME}"


	THE_MABOX_ADJUSTMENT_HELPER_DIR_NAME="helper"
	THE_MABOX_ADJUSTMENT_HELPER_SYSTEM_DIR_PATH="${THE_MABOX_ADJUSTMENT_PLAN_SYSTEM_DIR_PATH}/${THE_MABOX_ADJUSTMENT_HELPER_DIR_NAME}"
	THE_MABOX_ADJUSTMENT_HELPER_PERSON_DIR_PATH="${THE_MABOX_ADJUSTMENT_PLAN_PERSON_DIR_PATH}/${THE_MABOX_ADJUSTMENT_HELPER_DIR_NAME}"


	THE_MABOX_ADJUSTMENT_SUB_MODULE_ROOT_DIR_NAME="sub"
...
base_var_dump () {
	...
	## mabox-adjustment
	util_debug_echo "THE_MABOX_ADJUSTMENT_PLAN_DIR_NAME=${THE_MABOX_ADJUSTMENT_PLAN_DIR_NAME}"
	util_debug_echo "THE_MABOX_ADJUSTMENT_PLAN_SYSTEM_DIR_PATH=${THE_MABOX_ADJUSTMENT_PLAN_SYSTEM_DIR_PATH}"
	util_debug_echo "THE_MABOX_ADJUSTMENT_PLAN_PERSON_DIR_PATH=${THE_MABOX_ADJUSTMENT_PLAN_PERSON_DIR_PATH}"

	util_debug_echo "THE_MABOX_ADJUSTMENT_HELPER_DIR_NAME=${THE_MABOX_ADJUSTMENT_HELPER_DIR_NAME}"
	util_debug_echo "THE_MABOX_ADJUSTMENT_HELPER_SYSTEM_DIR_PATH=${THE_MABOX_ADJUSTMENT_HELPER_SYSTEM_DIR_PATH}"
	util_debug_echo "THE_MABOX_ADJUSTMENT_HELPER_PERSON_DIR_PATH=${THE_MABOX_ADJUSTMENT_HELPER_PERSON_DIR_PATH}"


	util_debug_echo "THE_MABOX_ADJUSTMENT_SUB_MODULE_ROOT_DIR_NAME=${THE_MABOX_ADJUSTMENT_SUB_MODULE_ROOT_DIR_NAME}"
